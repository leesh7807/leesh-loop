...
The Publisher does not plan or execute work, synchronize later repository Plan corrections back to Notion, or decide workflow behavior. It publishes the immutable accepted Plan snapshot; the reusable [workflow template](docs/WORKFLOW_TEMPLATE.md) defines the later execution binding and lifecycle.
