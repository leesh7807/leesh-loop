...
- `README.md` and `SPEC.md` for workflow/config contract changes. The runtime input is caller-owned;
  do not add a bundled execution `WORKFLOW.md` to this project.
