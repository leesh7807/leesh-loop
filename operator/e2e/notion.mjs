import { paragraphText, relationIds, selectValue, textValue } from './common.mjs';

const API = 'https://api.notion.com/v1';
const PLAN_PROPERTY = 'Plan';
const PAGE_SIZE = 100;

export class NotionCapability {
  constructor({ token = process.env.NOTION_TOKEN, fetcher = globalThis.fetch } = {}) {
    if (!token) throw new Error('NOTION_TOKEN is required for the E2E Notion capability');
    this.token = token;
