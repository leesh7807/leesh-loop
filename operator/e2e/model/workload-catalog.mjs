...
import { deriveIdentifier, sha256 } from './plan-identity.mjs';
...
export function selectAvailableWorkload(catalog, { random = Math.random, unavailableIdentifiers = new Set() } = {}) {
