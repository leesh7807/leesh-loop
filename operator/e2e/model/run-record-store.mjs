...
export function createRunRecord({ config, runId, workload, paths, startedAt = currentTimeIso() }) {
  ...
  return {
    ...
    artifacts: { task_id: null, task_url: null, task_identifier: null, publisher_result: null, plan_binding: null, delivery_prs: [], delivered_head: null, delivered_head_locked: false, merged_head: null, remote_base_commit: null },
