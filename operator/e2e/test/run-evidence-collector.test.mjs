...
test('chatgpt-shot timing keeps an observation duration when Jobs has no timestamps', async () => {
  ...
  const collector = new RunEvidenceCollector({
    ...
    operatorClient: { async readSymphonyRuntimeStatus() { return {}; }, async readSymphonyRuntimeState() { return {}; }, async readSymphonyIssue() { return null; }, async readDispatchedTrackerInput() { return null; } },
