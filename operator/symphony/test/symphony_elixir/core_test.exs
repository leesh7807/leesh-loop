defmodule SymphonyElixir.CoreTest do
  ...
  test "Memory workflow fixture is valid and renders a prompt" do
    original_workflow_path = Workflow.workflow_file_path()

    on_exit(fn -> Workflow.set_workflow_file_path(original_workflow_path) end)

    Workflow.set_workflow_file_path(Path.expand("../fixtures/startup_workflow.md", __DIR__))
  ...
  test "Memory workflow template fixture renders correctly" do
    workflow_path = Workflow.workflow_file_path()
    Workflow.set_workflow_file_path(Path.expand("../fixtures/template_workflow.md", __DIR__))
    ...
    assert prompt =~ "You are working on a Memory ticket `MT-616`"
  ...
  test "app server starts with workspace cwd and expected startup command" do
    ...
    try do
      ...
      expected_turn_sandbox_policy = %{
        "type" => "workspaceWrite",
        "writableRoots" => [canonical_workspace, Path.join(canonical_workspace, ".git"), Path.expand(System.tmp_dir!())],
        "networkAccess" => true,
